...
assert.strictEqual(renderer.findLogo(), logoRef);
assert.strictEqual(renderer.findLogoVertical(), logoRef);
assert.strictEqual(renderer.logoForFormat(1080, 1920), logoRef);
assert.strictEqual(renderer.logoForFormat(1920, 1080), logoRef);
