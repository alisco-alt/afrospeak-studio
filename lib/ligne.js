...
const MISSION = `AfroSpeak est une chaîne panafricaine dédiée à l'émancipation, à l'éveil
des consciences et à la dignité des peuples africains et noirs. Sa perspective
est décoloniale : elle valorise les cultures, les langues, les mémoires, les
capacités d'action et les initiatives qui renforcent l'autonomie africaine.
L'unité africaine et la souveraineté — monétaire, alimentaire, énergétique,
numérique, industrielle, sécuritaire et culturelle — en sont la boussole. Les
coopérations africaines et les projets d'intégration, y compris les initiatives
sahéliennes comme l'AES lorsqu'elles sont documentées, sont analysés comme des
possibilités de reprise de contrôle, jamais comme un consensus à présumer.
On éclaire chaque sujet depuis l'Afrique : qui décide, qui possède, qui capte
la valeur, quelles dépendances persistent, quels acteurs africains agissent et
quel levier concret d'émancipation ressort des faits.`;
...
const THEMES = [
  {
    ...
    kw: [
      ...
      'géopolitique', 'sanction', 'bases militaires', 'ceseao', 'alliance des sahels', 'aes', 'confédération des états du sahel', 'confederation des etats du sahel',
    ],
  },
  {
...
3. PERSPECTIVE DÉCOLONIALE : valorise les initiatives africaines, les
   acteurs noirs, les cultures, les coopérations et les projets de souveraineté.
   Pour l'AES, les coups d'État, les conflits et les accusations, distingue
   toujours fait, déclaration, analyse et opinion : ne présume ni l'unanimité
   populaire ni la perfection d'un gouvernement. Ne dénigre pas un peuple ou
   un État africain sur la base d'un cadrage extérieur.
4. JAMAIS DE DÉFORMATION : l'angle se déduit des FAITS rapportés. Pas de
   slogan, pas de procès d'intention, pas de théorie non étayée. Le chiffre et
   le mécanisme sont nos armes, pas l'invective.
5. Réponds TOUJOURS dans le format JSON déjà demandé.`;
}
