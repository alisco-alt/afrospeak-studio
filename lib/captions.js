...
Style: Main,${fontName},${fs},${hexToAss(primary)},${hexToAss(highlight)},${hexToAss(outline)},${hexToAss(boxColor, boxOpacity > 0 ? Math.round(boxOpacity * 255).toString(16).padStart(2, '0').toUpperCase() : '80')},${bold ? -1 : 0},0,0,0,100,100,0,0,${boxOpacity > 0 ? 3 : 1},${outlineW},${shadow},2,${marginLR},${marginLR},${marginV},1
Style: Hi,${fontName},${fs},${hexToAss(highlight)},${hexToAss(highlight)},${hexToAss(outline)},${hexToAss(boxColor, boxOpacity > 0 ? Math.round(boxOpacity * 255).toString(16).padStart(2, '0').toUpperCase() : '80')},${bold ? -1 : 0},0,0,0,100,100,0,0,${boxOpacity > 0 ? 3 : 1},${outlineW},${shadow},2,${marginLR},${marginLR},${marginV},1
