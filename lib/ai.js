...
async function chat(messages, { json = false, temperature = 0.8, maxTokens = 4000 } = {}) {
  ...
  // Défaut migré : llama-3.3-70b-versatile est arrêté par Groq le 16/08/2026.
  if (k.groq) providers.push({ name: 'groq', base: 'https://api.groq.com/openai/v1', key: k.groq, model: k.groqModel || 'openai/gpt-oss-120b' });
