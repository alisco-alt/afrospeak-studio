...
La narration du TOUT PREMIER plan est exactement la phrase "hook" : rien ne la précède. "figure" seulement pour kind="data" (sinon null). "query" décrit une image RÉELLE trouvable dans une banque d'images (ex : "lagos port containers", "african farmer cocoa", "trader screens finance"). Jamais de nom de personne célèbre dans "query".`;
}
...
nommément cité comme moteur du changement. Ces deux éléments servent la
démonstration du sujet : deux phrases maximum chacun, puis retour au sujet.
...
module.exports = {
  ...
  buildUserPrompt,   // exposé pour vérifier le prompt sans appeler le LLM
};
