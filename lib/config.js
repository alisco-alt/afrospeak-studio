...
const DEFAULTS = {
  ...
  autopilot: {
    ...
    intervalMinutes: 180,
    perRun: 1,
    /* Sources de veille : généralistes + flux de ligne éditoriale
     * (souveraineté, ZLECAf/unité, industrie, minerais, histoire). */
    /* Sources africaines spécialisées en premier ; les médias généralistes
     * restent utiles pour recouper, mais ne doivent jamais imposer seuls le
     * cadrage d'une initiative du continent. */
    sources: ['ecofin', 'ecofin_finance', 'financialafrik', 'sikafinance',
      'apanews', 'afrikcom', 'aip', 'burkina24', 'seneweb', 'togofirst',
      'beninwebtv', 'aib', 'africanews_fr', 'techcabal', 'techpoint',
      'africanarguments', 'theelephant', 'jeuneafrique', 'rfiafrique', 'bbcafrique',
      'ligne_souverainete', 'ligne_zlecaf', 'ligne_transformation',
      'ligne_ressources', 'ligne_histoire'],
...
function load() {
  ...
  const envMap = {
    ...
    pixabay: 'PIXABAY_API_KEY', unsplash: 'UNSPLASH_ACCESS_KEY', coverr: 'COVERR_API_KEY',
