...
async function speak(text, opts = {}) {
  ...
  const respirer = (t) => {
    ...
    s = s.replace(/\b(Mais|Pourtant|Cependant|Or|Ainsi|Donc|Alors|Aujourd'hui|Désormais|En réalité|En effet|Résultat|Problème|Conséquence)\s+(?![,;:])/gi,
      (m, mot) => `${mot}, `);
