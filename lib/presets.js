...
const FORMATS = {
  ...
  vertical: { id: 'vertical', label: '9:16 Shorts / TikTok', w: 1080, h: 1920, safe: 80, defaultStyle: 'viral' },
...
const STYLES = {
  ...
  bankable: {
    id: 'bankable',
    label: 'Bankable',
    desc: 'Actualité économique premium — mot prononcé coloré, contour noir, typographie impact, tiers-bas fixe',
    shotSeconds: [1.5, 2.8],
    /* Le mot actif est coloré par-dessus la ligne blanche. Aucun nuage,
     * rectangle ou bande semi-transparente ne passe derrière les sous-titres. */
    captionMode: 'karaoke',
    captionActiveBox: false,
    ...
    captionHighlight: '#58A6FF',  // bleu : noms propres et chiffres clés
    captionPill: '#FFE14D',       // le nuage jaune qui suit la voix
    captionPillText: '#FFFFFF',   // mot prononcé : blanc sur le nuage (demande)
    captionAccentOnPill: '#0D47A1', // mot important prononcé : bleu foncé sur jaune
    captionUpper: false,           // mixed case (more readable than all-caps for French)
    captionOutline: 0.09,          // outline for edge contrast
    entity: '#58A6FF',             // noms propres et sigles en bleu
    accentBar: true,
    lowerThird: true,
    transitions: ['fadefast', 'smoothleft', 'smoothright', 'wipeup', 'wipedown', 'dissolve', 'slideleft', 'slideright'],
    transitionDur: 0.18,
    noHardCuts: true,
    zoom: 0.10,                    // strong Ken Burns for dynamism
  ...
  brut: {
    ...
    desc: 'Coupes rapides, sous-titres mot-à-mot contrastés et propres. Idéal Shorts.',
    shotSeconds: [1.5, 2.8],
    captionMode: 'karaoke',
    captionFont: 'Montserrat-Black.ttf',
    captionSize: 0.055,
    ...
    captionUpper: true,
    captionColor: '#FFFFFF',
    captionHighlight: '#58A6FF',   // bleu : noms propres et mots forts
    captionPill: '#FFE14D',        // nuage jaune, signature Brut
    captionPillText: '#FFFFFF',    // mot prononcé : blanc sur le nuage
    captionAccentOnPill: '#0D47A1',
    captionOutline: 0.11,          // contour épais : lisible sur tout fond
    entity: '#58A6FF',             // noms propres et mots forts en bleu
    accentBar: false,
    lowerThird: true,
    transitions: ['fadefast', 'smoothleft', 'smoothright', 'wipeup', 'wipedown', 'dissolve', 'slideleft', 'slideright'],
    transitionDur: 0.18,
    ...
    ducking: 0.28,
    wpm: 175,
    /* Habillage de chaîne : le médaillon vertical ou le bloc horizontal
     * descend sous la zone occupée par les barres sociales. */
    logoPos: 'top-right',
    logoTopRatio: 0.10,
    logoWidthRatio: 0.13,
    logoOpacity: 1,
    logoMarginRatio: 0.026,
  },
  moneyradar: {
    id: 'moneyradar',
    ...
    captionOutline: 0.13,
    entity: '#58A6FF',             // noms propres et sigles en bleu (harmonisation)
    accentBar: true,
    lowerThird: true,
   ...
   *   · sous-titre mot-à-mot contrasté, sans plaque derrière le texte ;
  ...
  viral: {
    ...
    desc: 'Sous-titres mot-à-mot contrastés + recadrage plein cadre + slides de chiffres. Le look des grandes chaînes faceless (TikTok/Shorts/Reels).',
    shotSeconds: [1.4, 2.6],
    captionMode: 'karaoke',
    captionFont: 'Montserrat-Black.ttf',      // Montserrat Black : très gras et lisible sur mobile
    captionSize: 0.062,                    // géant — lu sur un téléphone de 3 mètres
    captionBox: 0,
    captionPos: 0.80,
    captionUpper: true,
    captionColor: '#FFFFFF',
    captionHighlight: '#FFFFFF',           // les mots inactifs restent blancs
    captionPill: '#FFE14D',
    captionPillText: '#FFFFFF',            // mot prononcé : blanc sur le jaune opaque
    captionAccentOnPill: '#0D47A1',        // mot important prononcé : bleu foncé sur jaune
    ...
    ducking: 0.26,
    wpm: 175,
    /* L'ancrage vertical est normalisé par le renderer en haut à droite ;
     * le paysage reste en haut-droite. Le même visuel n'est jamais doublé. */
    logoPos: 'top-right',
    logoTopRatio: 0.10,
    /* Les dimensions sont pilotées par le format : médaillon en vertical,
     * bloc horizontal en paysage. */
    logoWidthRatio: 0.13,
    logoOpacity: 1,
    logoMarginRatio: 0.026,
    hookPunch: true,               // plan 0 : zoom ×1,6 plafonné — le « punch » d'ouverture des gros canaux
  },
  doc: {
    id: 'doc',
  ...
  impact: {
    ...
    desc: 'Format court (60-90s), mot prononcé coloré par-dessus une ligne blanche, rythme rapide, accroche choc. Style chaînes éco africaines.',
    shotSeconds: [1.2, 2.5],
    captionMode: 'karaoke',
    captionFont: 'Montserrat-Black.ttf',
    captionSize: 0.052,
    ...
    logoPos: 'top-right', // position unique, safe zone haut-droite dans tous les formats
    logoTopRatio: 0.10,
    logoWidthRatio: 0.13,
    logoOpacity: 1,
    logoMarginRatio: 0.026,
