...
const STYLES = {
  ...
  brut: {
    ...
    ducking: 0.28,
    wpm: 175,
    /* Habillage de chaîne : le logo complet reste lisible, mais descend
     * sous la zone occupée par les barres et boutons Shorts/Reels/TikTok. */
    logoPos: 'top-right',
    logoTopRatio: 0.10,
    logoWidthRatio: 0.13,
    logoOpacity: 0.86,
  ...
  viral: {
    ...
    ducking: 0.26,
    wpm: 175,
    /* Bug de chaîne professionnel : en vertical, le logo centré en haut
     * rivalise avec le hook et ressemble à un sticker. On l'ancre dans le
     * coin haut-droit, plus discret et plus conforme aux habillages sociaux. */
    logoPos: 'top-right',
    logoTopRatio: 0.10,
    /* Logo complet AFRO SPEAK : assez large pour rester lisible en 9:16,
     * sans concurrencer l'accroche. */
    logoWidthRatio: 0.13,
    logoOpacity: 0.86,
    logoMarginRatio: 0.026,
  ...
  impact: {
    ...
    logoPos: 'top-right', // logo complet, jamais centré au-dessus du hook
    logoTopRatio: 0.10,
    logoWidthRatio: 0.13,
    logoOpacity: 0.86,
    logoMarginRatio: 0.026,
