...
const STYLES = {
  ...
  bankable: {
    id: 'bankable',
    label: 'Bankable',
    desc: 'Actualité économique premium — boîte pleine, typographie impact, tiers-bas fixe',
    shotSeconds: [1.5, 2.8],
    captionMode: 'word',           // 1 word at a time = punchy, matches reference reels
    captionFont: 'Montserrat-Black.ttf',
    captionSize: 0.058,            // large text for readability on mobile
    captionBox: 0.95,              // nearly opaque box background
    ...
    captionOutline: 0.06,          // subtle outline for edge contrast
    accentBar: true,
    lowerThird: true,
    transitions: ['cut', 'hblur', 'cut', 'smoothleft', 'cut', 'hblur', 'cut', 'smoothright', 'cut', 'fadefast'],
    transitionDur: 0.18,
    zoom: 0.18,                    // strong Ken Burns for dynamism
  ...
  impact: {
    ...
    desc: 'Format court (60-90s), sous-titres en boîte colorée, rythme rapide, accroche choc. Style chaînes éco africaines.',
    shotSeconds: [1.2, 2.5],
    captionMode: 'karaoke',
    captionFont: 'Montserrat-Black.ttf',
    captionSize: 0.052,
    captionBox: 0.85,             // boîte de fond très opaque
    captionBoxColor: 'brand',     // utiliser la couleur de marque (or) au lieu du noir
    captionPos: 0.82,
    captionUpper: true,
    captionColor: '#FFFFFF',
    captionHighlight: '#0B0F14',  // texte surligné en foncé sur fond or
    captionOutline: 0.08,
    accentBar: true,
    lowerThird: true,
...
const GRADES = {
  ...
  cinema: 'eq=contrast=1.12:saturation={sat}:gamma=0.98:gamma_b=0.97,curves=preset=increase_contrast,noise=alls=3:allf=t+u',
};
