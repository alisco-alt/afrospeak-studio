...
const STYLES = {
  ecofin: {
    ...
    accentBar: true,
    lowerThird: true,
    transitions: ['cut', 'cut', 'cut', 'cut', 'cut', 'cut', 'cut', 'cut', 'cut', 'fade'],
    transitionDur: 0.2,
    zoom: 0.06,
    saturation: 1.03,
    vignette: 0.15,
  ...
  doc: {
    ...
    accentBar: false,
    lowerThird: false,
    transitions: ['cut', 'cut', 'cut', 'cut', 'cut', 'cut', 'cut', 'fade', 'fade', 'fade'],
    transitionDur: 0.45,
    zoom: 0.05,
    saturation: 1.0,
    vignette: 0.22,
  ...
  impact: {
    ...
    accentBar: true,
    lowerThird: true,
    transitions: ['cut', 'cut', 'cut', 'cut', 'cut', 'cut', 'cut', 'cut', 'cut', 'zoom'],
    transitionDur: 0.2,
    zoom: 0.12,
    saturation: 1.15,
    vignette: 0.15,
