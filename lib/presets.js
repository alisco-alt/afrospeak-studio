...
const STYLES = {
  ...
  viral: {
    ...
    captionUpper: true,
    captionColor: '#FFFFFF',
    captionHighlight: '#58A6FF',           // bleu : noms propres / mots forts
    captionPill: '#FFE14D',
    captionPillText: '#FFFFFF',            // mot prononcé : blanc sur le nuage
    captionAccentOnPill: '#0D47A1',        // mot important prononcé : bleu foncé sur jaune
    ...
    ducking: 0.26,
    wpm: 175,
    /* L'ancrage vertical est normalisé par le renderer en haut-centre ;
  ...
  impact: {
    ...
    logoPos: 'top-right', // paysage ; le vertical est centré par le renderer
    logoTopRatio: 0.10,
    logoWidthRatio: 0.13,
    logoOpacity: 1,
    logoMarginRatio: 0.026,
