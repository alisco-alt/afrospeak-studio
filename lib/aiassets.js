...
const QUALITE_PHOTO = 'high-resolution editorial still photograph, tack-sharp focal subject, '
  + 'fine natural texture, physically accurate materials and perspective, realistic daylight, '
  + 'clean professional focus, no CGI, no 3D render, no digital painting, no plastic skin, '
  + 'no malformed hands, no motion blur, no excessive bokeh';
