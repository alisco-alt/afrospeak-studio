...
const PROVIDERS = {
  ...
  shutterstock: searchShutterstock,
...
function defaultProviders() {
  ...
  const banques = ['pexels', 'pixabay', 'unsplash', 'shutterstock', 'openverse', 'wikimedia', 'archive'];
...
module.exports = {
  ...
  searchPexels, searchPixabay, searchUnsplash, searchShutterstock, searchOpenverse, searchWikimedia, searchNasa,
