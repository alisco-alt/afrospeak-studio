...
const PROVIDERS = {
  ...
  wikimediaVideo: searchWikimediaVideo,
...
async function download(asset, opts = {}) {
  ...
  const res = await fetchBuf(asset.url, {
    timeout: 60000, retries: 2, maxBytes: 120 * 1024 * 1024, headers: enTetes,
  });
...
module.exports = {
  ...
  searchDuckDuckGo, searchBing, searchGdelt, searchWikimediaVideo,
